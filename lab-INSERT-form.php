<?php
	...
	$sql = "INSERT INTO lab_wagons (prod_name, prod_price, prod_color, prod_wagon, prod_wagon_ordered) VALUES (:prod_name, :prod_price, :prod_color, :prod_wagon, :prod_wagon_ordered)";
	...
	try {
		...
		$stmt->bindParam(':prod_wagon_ordered', $date);
